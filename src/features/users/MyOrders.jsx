...
const MyOrders = () => {
	...
	return (
		<div className="m-0 p-0 min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col">
			<div className="flex-1 flex flex-col w-full max-w-[98vw] mx-auto">
				<Card className="flex-1 flex flex-col p-1 xs:p-2 sm:p-6 shadow-2xl border-0 bg-white/95 rounded-3xl w-full h-full">
					<h2 className="text-lg sm:text-2xl font-extrabold mb-4 text-blue-900 text-center tracking-tight">
						My Orders
					</h2>
					<Tabs
						value={activeStatus}
