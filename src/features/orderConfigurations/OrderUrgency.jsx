  ...
  return (
    <React.Fragment>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2">
        <h2 className="text-base xs:text-lg sm:text-xl font-semibold text-gray-900">Order Urgency Management</h2>
        <Button
      ...
      {loading ? (
        <div className="text-center py-8 text-gray-500">Loading order urgency options...</div>
      ) : error ? (
