  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2">
        <h2 className="text-base xs:text-lg sm:text-xl font-semibold text-blue-900">Order Pages Management</h2>
        <Button
      ...
      {loading ? (
        <div className="text-center py-8 text-blue-700">Loading order pages...</div>
      ) : error ? (
          ...
          <table className="w-full border-separate border-spacing-y-0 rounded-2xl overflow-hidden shadow-xl bg-white">
            ...
            <tbody className="divide-y divide-blue-100">
              {orderPages.length > 0 ? orderPages.map((page, idx) => (
                <tr key={page.id} className={`transition group ${idx % 2 === 0 ? 'bg-white' : 'bg-blue-50'} hover:bg-blue-100`} style={{ boxShadow: '0 1px 4px 0 rgba(30, 64, 175, 0.04)' }}>
                  <td className="px-6 py-4 font-semibold text-blue-900 capitalize align-middle">{page.name}</td>
