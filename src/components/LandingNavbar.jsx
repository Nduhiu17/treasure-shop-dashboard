	...
	<nav className="w-full flex items-center justify-between px-2 xs:px-4 py-2 xs:py-3 rounded-b-3xl bg-white/95 shadow-lg">
	  ...
	  <li>
		<a
		  ...
		  className="font-bold text-green-600 hover:text-green-700 transition-colors flex items-center gap-2 px-4 py-2 rounded-2xl hover:bg-green-50"
...
{mobileMenuOpen && (
  ...
  >
	  ...
	  <a
		...
		target="_blank"
		rel="noopener noreferrer"
		className="rounded-xl bg-gradient-to-br from-green-50 via-green-100 to-green-200 shadow border border-green-200 px-3 py-2 text-green-700 hover:text-green-800 transition-colors block min-w-0 flex items-center gap-2"
		onClick={() => setMobileMenuOpen(false)}
		title="Chat with us on WhatsApp"
	  >
		<svg
